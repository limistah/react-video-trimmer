  ...
  (function(_EventEmitter) {
    ...
    function WebVideo(videoFile) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(WebVideo).call(this)
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "trimVideo", function() {
        ...
        workerClient.runCommand(
          "-ss "
            .concat(startSeconds, " -c copy -t ")
            .concat(length, " sliced-output.mp4")
        );
      });
                      ...
                      while (1) {
                        switch ((_context5.prev = _context5.next)) {
                          case 0:
                            ...
                            (_ref6 = [video.videoWidth, video.videoHeight]),
                              (w = _ref6[0]),
                              (h = _ref6[1]);
                            canvas.width = w;
                            canvas.height = h;
      ...
      workerClient.on("onDone", function(data) {
        return _this.emit("FFMPEGDone", data);
      });
      return _this;
    }
