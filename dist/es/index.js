  ...
  (function(_React$PureComponent) {
    ...
    function ReactVideoTrimmer(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(ReactVideoTrimmer).call(this, props)
      );
    ...
    _createClass(ReactVideoTrimmer, [
      {
        ...
        value: function render() {
          ...
          return React.createElement(
            ...
            encoded
              ? React.createElement(this.VideoPlayerNoTrimmer, null)
              : React.createElement(
                  React.Fragment,
                  null,
                  !decoding &&
                  ...
                  React.createElement(this.VideoPlayerWithTrimmer, {
                    showTrimmer: true
                  })
                )
          );
