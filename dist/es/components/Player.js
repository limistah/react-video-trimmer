  ...
  (function(_React$Component) {
    ...
    function VideoPlayer() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(VideoPlayer)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(
        ...
        function(data) {
          if (data.loaded) {
            ...
            var playedSecondsIsLowerThanStartTime =
              playedSeconds <= startTimeRange;
            var playedSecondsIsGreaterThanEndTime =
              playedSeconds >= endTimeRange;
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              _defineProperty(
                _React$createElement,
                "onProgress",
                this.handlePlayerProgress
              ),
              _defineProperty(_React$createElement, "url", this.props.src),
