  ...
  (function(_PureComponent) {
    ...
    function Trimmer() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Trimmer)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "time2pos", function(
        time
      ) {
        return time * _this.props.widthDurationRatio;
      });

      _defineProperty(_assertThisInitialized(_this), "keepInRange", function(
        x
      ) {
  ...
  (function(_PureComponent2) {
    ...
    function VideoTrimmer() {
      ...
      _this2 = _possibleConstructorReturn(
        this,
        (_getPrototypeOf3 = _getPrototypeOf(VideoTrimmer)).call.apply(
          _getPrototypeOf3,
          [this].concat(args)
        )
      );
